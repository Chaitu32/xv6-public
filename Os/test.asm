...
int main(int argc,char* argv[]){
  ...
  13:	83 ec 10             	sub    $0x10,%esp
    int pid = fork();
  16:	e8 00 03 00 00       	call   31b <fork>
    if(pid<0){
  1b:	85 c0                	test   %eax,%eax
  1d:	78 53                	js     72 <main+0x72>
        exit(); 
    }
    if(pid==0){
  1f:	75 56                	jne    77 <main+0x77>
        sleep(2);
  21:	83 ec 0c             	sub    $0xc,%esp
  24:	bb 05 00 00 00       	mov    $0x5,%ebx
  29:	6a 02                	push   $0x2
  2b:	e8 83 03 00 00       	call   3b3 <sleep>
  30:	83 c4 10             	add    $0x10,%esp
        for(int j=0;j<5;j++){
            printf(1,"This is child with pid %d\n",getpid());
  33:	e8 6b 03 00 00       	call   3a3 <getpid>
  ...
  43:	e8 48 04 00 00       	call   490 <printf>
            ...
            sleep(10);
  48:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  4f:	e8 5f 03 00 00       	call   3b3 <sleep>
        for(int j=0;j<5;j++){
  54:	83 c4 10             	add    $0x10,%esp
  57:	83 eb 01             	sub    $0x1,%ebx
  5a:	75 d7                	jne    33 <main+0x33>
        }
        printf(1,"This is child with pid %d getting exit.\n",getpid());
  5c:	e8 42 03 00 00       	call   3a3 <getpid>
  61:	51                   	push   %ecx
  62:	50                   	push   %eax
  63:	68 2c 08 00 00       	push   $0x82c
  68:	6a 01                	push   $0x1
  6a:	e8 21 04 00 00       	call   490 <printf>
  6f:	83 c4 10             	add    $0x10,%esp
        exit(); 
  72:	e8 ac 02 00 00       	call   323 <exit>
  77:	89 c3                	mov    %eax,%ebx
    }
    else{
        int w,r;
        printf(1,"parent with pid %d waiting for child with pid %d\n",getpid(),pid);
  79:	e8 25 03 00 00       	call   3a3 <getpid>
  7e:	53                   	push   %ebx
  7f:	50                   	push   %eax
  80:	68 58 08 00 00       	push   $0x858
  85:	6a 01                	push   $0x1
  ...
  90:	5a                   	pop    %edx
  91:	50                   	push   %eax
  92:	8d 45 f0             	lea    -0x10(%ebp),%eax
  95:	50                   	push   %eax
  96:	e8 28 03 00 00       	call   3c3 <waitx>
        printf(1,"test completed %d %d\n",w,r);
  9b:	ff 75 f4             	pushl  -0xc(%ebp)
  9e:	ff 75 f0             	pushl  -0x10(%ebp)
  a1:	68 13 08 00 00       	push   $0x813
  a6:	6a 01                	push   $0x1
  a8:	e8 e3 03 00 00       	call   490 <printf>
  ad:	83 c4 20             	add    $0x20,%esp
  b0:	eb c0                	jmp    72 <main+0x72>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 8a 08 00 00       	mov    $0x88a,%ebx
        while(*s != 0){
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 40 0b 00 00       	mov    0xb40,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 44 0b 00 00       	mov    $0xb44,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7e2:	00 00 00 
    if(p->s.size >= nunits){
