...
int main(int argc,char* argv[]){
  ...
  1a:	50                   	push   %eax
  1b:	50                   	push   %eax
  1c:	68 78 07 00 00       	push   $0x778
  21:	6a 01                	push   $0x1
  23:	e8 e8 03 00 00       	call   410 <printf>
        exit();
  28:	e8 76 02 00 00       	call   2a3 <exit>
    }
    cpu_ps();
  2d:	e8 19 03 00 00       	call   34b <cpu_ps>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb 9e 07 00 00       	mov    $0x79e,%ebx
        while(*s != 0){
 ...
 606:	73 10                	jae    618 <free+0x38>
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 639:	5d                   	pop    %ebp
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 50 0a 00 00       	mov    %eax,0xa50
    p->s.size += bp->s.size;
